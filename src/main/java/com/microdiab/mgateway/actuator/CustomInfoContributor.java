...
public class CustomInfoContributor implements InfoContributor {
    ...
    public void contribute(Info.Builder builder) {
        ...
        appInfo.put("version", environment.getProperty("info.app.version", "mgateway - Version non définie"));
        appInfo.put("description", environment.getProperty("info.app.description", "mgateway - Description non définie"));
        appInfo.put("documentation", environment.getProperty("info.app.documentation", "mgateway - Documentation non définie"));
        appInfo.put("information", environment.getProperty("info.app.information", "mgateway - Informations non définies"));
